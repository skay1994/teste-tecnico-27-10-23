...
function updatePatient() {
    ...
    axios.post(`/api/patients/${route.params.id}`, formData, {
        headers: {
...
function hasError(field: string) {
    return errors && field in errors && errors[field].length
}
    ...
    <div class="container p-6">
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <h2 class="text-base font-semibold leading-7 text-gray-900">Atualizar Paciente</h2>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-4" v-if="photo">
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <span class="text-red-600" v-if="hasError('address.0.zipcode')">{{ errors['address.0.zipcode'][0] }}</span>
                    </div>
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <span class="text-red-600" v-if="hasError('address.0.street')">{{ errors['address.0.street'][0] }}</span>
                    </div>
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <span class="text-red-600" v-if="hasError('address.0.number')">{{ errors['address.0.number'][0] }}</span>
                    </div>
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <span class="text-red-600" v-if="hasError('address.0.city')">{{ errors['address.0.city'][0] }}</span>
                    </div>
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <span class="text-red-600" v-if="hasError('address.0.state')">{{ errors['address.0.state'][0] }}</span>
                    </div>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            ...
            <button @click="updatePatient" type="button" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Save</button>
        </div>
    </div>
</template>
